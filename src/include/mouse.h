...
void update_mouse_button_state(device_t *, uint8_t, uint8_t);
void update_remote_mouse_button_state(device_t *, uint8_t);
uint8_t combine_mouse_button_states(device_t *);
void release_mouse_buttons(device_t *);
